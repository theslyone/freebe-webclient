...
function errorHTML(a, b) {
  var c, d, e = "less-error-message:" + extractId(b || ""),
  ...
  a.extract ? (k(a, 0, ""), k(a, 1, "line"), k(a, 2, ""), d += "on line " + a.line + ", column " + (a.column + 1) + ":</p>" + "<ul>" + h.join("") + "</ul>") : a.stack && (d += "<br/>" + a.stack.split("\n").slice(1).join("<br/>")), g.innerHTML = d, createCSS([".less-error-message ul, .less-error-message li {", "list-style-type: none;", "margin-right: 15px;", "padding: 4px 0;", "margin: 0;", "}", ".less-error-message label {", "font-size: 12px;", "margin-right: 15px;", "padding: 4px 0;", "color: #cc7777;", "}", ".less-error-message pre {", "color: #dd6666;", "padding: 4px 0;", "margin: 0;", "display: inline-block;", "}", ".less-error-message pre.line {", "color: #ff0000;", "}", ".less-error-message h3 {", "font-size: 20px;", "font-weight: bold;", "padding: 15px 0 5px 0;", "margin: 0;", "}", ".less-error-message a {", "color: #10a", "}", ".less-error-message .error {", "color: red;", "font-weight: bold;", "padding-bottom: 2px;", "border-bottom: 1px dashed red;", "}"].join("\n"), {
    title: "error-message"
  }), g.style.cssText = ["font-family: Arial, sans-serif", "border: 1px solid #e00", "background-color: #eee", "border-radius: 5px", "-webkit-border-radius: 5px", "-moz-border-radius: 5px", "color: #e00", "padding: 15px", "margin-bottom: 15px"].join(";"), "development" == less.env && (c = setInterval(function() {
...
function pathDiff(a, b) {
  var c, d, e, f, g = extractUrlParts(a),
    h = extractUrlParts(b),
    i = "";
...
void 0 === less && (less = exports, tree = require("./tree"), less.mode = "node"), less.Parser = function(a) {
    ...
    return n.prototype = new Error, n.prototype.constructor = n, this.env = a = a || {}, this.optimization = "optimization" in this.env ? this.env.optimization : 1, w = {
      ...
      parse: function(b, c) {
        ...
        if (p = q = v = t = 0, o = b.replace(/\r\n/g, "\n"), o = o.replace(/^\uFEFF/, ""), w.imports.contents[a.currentFileInfo.filename] = o, u = function(b) {
            for (var c, d, e, f, g = 0, i = /(?:@\{[\w-]+\}|[^"'`\{\}\/\(\)\\])+/g, j = /\/\*(?:[^*]|\*+[^\/*])*\*+\/|\/\/.*/g, k = /"((?:[^"\\\r\n]|\\.)*)"|'((?:[^'\\\r\n]|\\.)*)'|`((?:[^`]|\\.)*)`/g, l = 0, m = b[0], p = 0; p < o.length;)
              if (i.lastIndex = p, (c = i.exec(o)) && c.index === p && (p += c[0].length, m.push(c[0])), e = o.charAt(p), j.lastIndex = k.lastIndex = p, (c = k.exec(o)) && c.index === p) p += c[0].length, m.push(c[0]);
        ...
        if (d.toCSS = function(b) {
            return function(c, d) {
              ...
              try {
                e = b.call(this, g), (new tree.joinSelectorVisitor).run(e), (new tree.processExtendsVisitor).run(e), new tree.toCSSVisitor({
      ...
      parsers: {
        primary: function() {
          for (var a, b = [];
            (a = f(this.extendRule) || f(this.mixin.definition) || f(this.rule) || f(this.ruleset) || f(this.mixin.call) || f(this.comment) || f(this.directive)) || f(/^[\s\n]+/) || f(/^;+/);) a && b.push(a);
          return b
        },
        comment: function() {
          var b;
          ...
          args: function(a) {
            for (var b, c, d, e, g, j, k = [], l = [], m = [], n = {
              ...
              if (a ? 1 == j.value.length && (q = j.value[0]) : q = j, q && q instanceof tree.Variable)
                if (f(":")) k.length > 0 && (b && i("Cannot mix ; and , as delimiter types"), c = !0), g = h(this.expression), e = d = q.name;
                else {
                  if (!a && f(/^\.{3}/)) {
                    n.variadic = !0, f(";") && !b && (b = !0), (b ? l : m).push({
                      name: j.name,
        ...
        selector: function(b) {
          for (var c, d, e, g, j, k = [], l = [];
            (b && (e = f(this.extend)) || b && (g = f(/^when/)) || (c = f(this.element))) && (g ? j = h(this.conditions, "expected condition") : j ? i("CSS guard can only be used at the end of selector") : e ? l.push.apply(l, e) : (l.length && i("Extend can only be used at the end of selector"), d = o.charAt(p), k.push(c), c = null), "{" !== d && "}" !== d && ";" !== d && "," !== d && ")" !== d););
        ...
        ruleset: function() {
          ...
          for (b(), a.dumpLineNumbers && (g = m(p, o, a));
            (d = f(this.lessSelector)) && (h.push(d), f(this.comments), f(","));) d.condition && i("Guards are only currently allowed on a single selector."), f(this.comments);
        ...
        mediaFeature: function() {
          ...
          do
            ...
            if (c && b) d.push(new tree.Paren(new tree.Rule(c, b, null, null, p, a.currentFileInfo, !0)));
            else {
              if (!b) return null;
        ...
        addition: function() {
          ...
          if (a = f(this.multiplication)) {
            for (g = e(o.charAt(p - 1));
              (c = f(/^[-+]\s+/) || !g && (f("+") || f("-"))) && (b = f(this.multiplication));) a.parensInOp = !0, b.parensInOp = !0, d = new tree.Operation(c, [d || a, b], g), g = e(o.charAt(p - 1));
            return d || a
          }
        },
        conditions: function() {
  ...
  function(a) {
    ...
    a.functions = {
      ...
      pow: function(b, c) {
        ...
        else if (!(b instanceof a.Dimension && c instanceof a.Dimension)) throw {
          type: "Argument",
      ...
      overlay: function(a, b) {
        var c = a.rgb[0] < 128 ? 2 * a.rgb[0] * b.rgb[0] / 255 : 255 - 2 * (255 - a.rgb[0]) * (255 - b.rgb[0]) / 255,
          d = a.rgb[1] < 128 ? 2 * a.rgb[1] * b.rgb[1] / 255 : 255 - 2 * (255 - a.rgb[1]) * (255 - b.rgb[1]) / 255,
          e = a.rgb[2] < 128 ? 2 * a.rgb[2] * b.rgb[2] / 255 : 255 - 2 * (255 - a.rgb[2]) * (255 - b.rgb[2]) / 255;
        return this.rgb(c, d, e)
      },
      ...
      hardlight: function(a, b) {
        var c = b.rgb[0] < 128 ? 2 * b.rgb[0] * a.rgb[0] / 255 : 255 - 2 * (255 - b.rgb[0]) * (255 - a.rgb[0]) / 255,
          d = b.rgb[1] < 128 ? 2 * b.rgb[1] * a.rgb[1] / 255 : 255 - 2 * (255 - b.rgb[1]) * (255 - a.rgb[1]) / 255,
          e = b.rgb[2] < 128 ? 2 * b.rgb[2] * a.rgb[2] / 255 : 255 - 2 * (255 - b.rgb[2]) * (255 - a.rgb[2]) / 255;
        return this.rgb(c, d, e)
      },
      ...
      "svg-gradient": function(b) {
        ...
        var d, e, f, g, h, i, j, k = Array.prototype.slice.call(arguments, 1),
          l = "linear",
  ...
  function(a) {
    a.mixin = {}, a.mixin.Call = function(b, c, d, e, f) {
      ...
      evalParams: function(b, c, d, e) {
        var f, g, h, i, j, k, l, m, n = new a.Ruleset(null, []),
  ...
  function(a) {
    a.Operation = function(a, b, c) {
      ...
      eval: function(b) {
        var c, d = this.operands[0].eval(b),
  ...
  function(a) {
    a.Ruleset = function(a, b, c) {
      ...
      accept: function(a) {
        if (this.paths)
          for (var b = 0; b < this.paths.length; b++) this.paths[b] = a.visit(this.paths[b]);
  ...
  function(a) {
    a.visitor = function(a) {
      ...
      visit: function(a) {
        ...
        var b, c, d = "visit" + a.type,
          e = this._implementation[d];
        return e && (b = {
          visitDeeper: !0
        }, c = e.call(this._implementation, a, b), this._implementation.isReplacing && (a = c)), (!b || b.visitDeeper) && a && a.accept && a.accept(this), d += "Out", this._implementation[d] && this._implementation[d](a), a
      },
  ...
  function(a) {
    a.toCSSVisitor = function(b) {
      ...
      visitRuleset: function(b, c) {
        var d, e = [];
        if (b.firstRoot && this.checkPropertiesInRoot(b.rules), b.root) b.accept(this._visitor), c.visitDeeper = !1, (b.firstRoot || b.rules.length > 0) && e.splice(0, 0, b);
        else {
    ...
    a.extendFinderVisitor = function() {
      ...
      doExtendChaining: function(b, c, d) {
        ...
        for (d = d || 0, e = 0; e < b.length; e++)
          for (f = 0; f < c.length; f++) j = b[e], k = c[f], this.inInheritanceChain(k, j) || (i = [k.selfSelectors[0]], g = n.findMatch(j, i), g.length && j.selfSelectors.forEach(function(b) {
      ...
      visitRuleset: function(a) {
        if (!a.root) {
          ...
          for (d = 0; d < f.length; d++)
            for (c = 0; c < a.paths.length; c++) e = a.paths[c], a.extendOnEveryPath || e[e.length - 1].extendList.length || (b = this.findMatch(f[d], e), b.length && f[d].selfSelectors.forEach(function(a) {
  ...
  function(a) {
    a.sourceMapOutput = function(a) {
      ...
      if (this._sourceMapGenerator = new this._sourceMapGeneratorConstructor({
        ...
        for (var b in this._contentsMap) this._sourceMapGenerator.setSourceContent(this.normalizeFilename(b), this._contentsMap[b]);
